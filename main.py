...
def startGame():
    ...
    mon = {'left': 10, 'top': 266, 'width': 510, 'height': 285}
    mon2 = {'left': 527, 'top': 266, 'width': 510, 'height': 285}

    with mss() as sct:
        while True:
            if not p1Playing and not p2Playing:
                break
...
# startGame()
while True:
    i = input("Press Enter To Start or q to exit:")
    if i == "q" or i == "Q":
        break
    startGame()
